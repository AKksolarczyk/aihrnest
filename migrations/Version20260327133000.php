...
final class Version20260327133000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE workspace_users (id VARCHAR(32) NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, team VARCHAR(255) NOT NULL, password_hash VARCHAR(255) NOT NULL, roles JSON NOT NULL, assigned_desk_id VARCHAR(32) DEFAULT NULL, schedule JSON NOT NULL, vacation_days_total INT NOT NULL, vacation_days_remaining INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX uniq_workspace_users_email ON workspace_users (email)');
